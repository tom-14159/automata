...
Modified by Martin Escardo 04 Nov 2013 just to make it compatible with
the current version of ghc. No other modification is present.

I am using this for teaching Functional Programming, 
School of CS, University of Birmingham, UK.
Posted here with Graham Hutton's permission.
...
apply' p xs      = fst (head (apply p xs))
